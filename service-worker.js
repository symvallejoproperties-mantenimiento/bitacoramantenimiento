const CACHE='bitacora-vp-ios-v8';
...
self.addEventListener('fetch',event=>{
  ...
  if(event.request.mode==='navigate'||['script','style','image'].includes(event.request.destination))event.respondWith(staleWhileRevalidate(event.request));
